...
- You're all set!
- Download this code as zip, and extract it to some folder like ```C:\temp\automate-vaccine-booking```
- The py files should be in ```C:\temp\automate-vaccine-booking\src```
- Open command prompt and run ```cd C:\temp\automate-vaccine-booking``` and complete two more steps mentioned in Usage section.
